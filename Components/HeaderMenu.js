...
function HeaderMenu ( props ) {
    return (
      <View style={styles.header}>
        ...
        onPress={() => {props.navegacao.navigate('Profile')}}>
       ...
       <TouchableHighlight 
        activeOpacity={0.6}
        underlayColor="#DDDDDD"        
        onPress={() => {props.navegacao.navigate('Chat')}}>
        <FontAwesome5 name={'comments'} size={30} color="#4F8EF7" />
        </TouchableHighlight>
      </View>
    )
}
